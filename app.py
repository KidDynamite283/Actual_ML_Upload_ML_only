...
label_encoders = {}
for column in ['Airline_Company', 'Departure_City', 'Arrival_City', 'Departure_Time_Category', 'Arrival_Time_Category']:
...
# Arrival Time Category input
arrival_time_category = st.selectbox('Select Arrival Time Category', label_encoders['Arrival_Time_Category'].classes_)
arrival_time_category_encoded = label_encoders['Arrival_Time_Category'].transform([arrival_time_category])[0]
...
input_data = np.array([[month_of_journey, airline_company_encoded, flight_class_encoded, departure_city_encoded, arrival_city_encoded, 
                        total_stops_encoded, weekend, difference_in_days, departure_time_category_encoded, arrival_time_category_encoded, journey_day]])
